...
/** Sum of every product row's Taxable Amount — shown as a subtotal above the Grand Total */
function productsTaxableTotal(products) {
  return round2((products || []).reduce((sum, p) => sum + (parseFloat(p.taxableAmount) || 0), 0));
}
