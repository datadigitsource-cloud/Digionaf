...
/** Fixed timezone for the whole app — every device shows the same clock, regardless of its own local timezone setting. */
const APP_TIMEZONE = 'Asia/Kolkata';

/** Format an ISO date string to dd-mm-yyyy, always in IST (Asia/Kolkata) */
...
/** Format an ISO datetime string to dd-mm-yyyy, hh:mm AM/PM, always in IST (Asia/Kolkata) */
